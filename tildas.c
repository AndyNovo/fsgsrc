...
#define VERSION 241 //id for the validation
...
int main () {
    ...
    char descriptions[5][65] = {"(Axe, Looting, Lighter, Obi Portal Only)", "(Village Only)", "(Shipwreck Only)", "(Jungle Only)", ""};
    printf("FSG v1.2.53 %s\n", descriptions[FILTER_TYPE]);
